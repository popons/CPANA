...
const uint32_t aes_rcon_tab[29] =
{
...
#ifdef  FT1_SET
const uint32_t aes_ft_tab[256] = { sb_data(u0) };
#endif
#ifdef  FT4_SET
const uint32_t aes_ft_tab[4][256] =
    { {  sb_data(u0) }, {  sb_data(u1) }, {  sb_data(u2) }, {  sb_data(u3) } };
#endif

#ifdef  FL1_SET
const uint32_t aes_fl_tab[256] = { sb_data(w0) };
#endif
#ifdef  FL4_SET
const uint32_t aes_fl_tab[4][256] =
    { {  sb_data(w0) }, {  sb_data(w1) }, {  sb_data(w2) }, {  sb_data(w3) } };
#endif

#ifdef  IT1_SET
const uint32_t aes_it_tab[256] = { isb_data(v0) };
#endif
#ifdef  IT4_SET
const uint32_t aes_it_tab[4][256] =
    { { isb_data(v0) }, { isb_data(v1) }, { isb_data(v2) }, { isb_data(v3) } };
#endif

#ifdef  IL1_SET
const uint32_t aes_il_tab[256] = { isb_data(w0) };
#endif
#ifdef  IL4_SET
const uint32_t aes_il_tab[4][256] =
...
#ifdef  IM1_SET
const uint32_t aes_im_tab[256] = { mm_data(v0) };
#endif
#ifdef  IM4_SET
const uint32_t aes_im_tab[4][256] =
...
uint32_t  aes_rcon_tab[RC_LENGTH];
...
#ifdef  FT1_SET
uint32_t aes_ft_tab[256];
#endif
#ifdef  FT4_SET
uint32_t aes_ft_tab[4][256];
#endif

#ifdef  FL1_SET
uint32_t aes_fl_tab[256];
#endif
#ifdef  FL4_SET
uint32_t aes_fl_tab[4][256];
#endif

#ifdef  IT1_SET
uint32_t aes_it_tab[256];
#endif
#ifdef  IT4_SET
uint32_t aes_it_tab[4][256];
#endif

#ifdef  IL1_SET
uint32_t aes_il_tab[256];
#endif
#ifdef  IL4_SET
uint32_t aes_il_tab[4][256];
#endif
...
#ifdef  IM1_SET
uint32_t aes_im_tab[256];
#endif
#ifdef  IM4_SET
uint32_t aes_im_tab[4][256];
#endif
...
{   uint32_t  i, w;
    ...
    */
    ...
    {
        aes_rcon_tab[i] = bytes2word(w, 0, 0, 0);
        w = f2(w);
    }
...
#ifdef  FT4_SET
        aes_ft_tab[0][i] = w;
        aes_ft_tab[1][i] = upr(w,1);
        aes_ft_tab[2][i] = upr(w,2);
        aes_ft_tab[3][i] = upr(w,3);
#endif
        w = bytes2word(b, 0, 0, 0);

#ifdef  FL1_SET                 /* tables for last encryption round (may also   */
        aes_fl_tab[i] = w;          /* be used in the key schedule)                 */
#endif
#ifdef  FL4_SET
        aes_fl_tab[0][i] = w;
        aes_fl_tab[1][i] = upr(w,1);
        aes_fl_tab[2][i] = upr(w,2);
        aes_fl_tab[3][i] = upr(w,3);
#endif

#ifdef  LS1_SET                 /* table for key schedule if aes_fl_tab above is    */
...
#ifdef  IM4_SET
        aes_im_tab[0][b] = w;
        aes_im_tab[1][b] = upr(w,1);
        aes_im_tab[2][b] = upr(w,2);
        aes_im_tab[3][b] = upr(w,3);
#endif
...
#ifdef  IT4_SET
        aes_it_tab[0][i] = w;
        aes_it_tab[1][i] = upr(w,1);
        aes_it_tab[2][i] = upr(w,2);
        aes_it_tab[3][i] = upr(w,3);
#endif
        w = bytes2word(b, 0, 0, 0);
...
#ifdef  IL4_SET
        aes_il_tab[0][i] = w;
        aes_il_tab[1][i] = upr(w,1);
        aes_il_tab[2][i] = upr(w,2);
        aes_il_tab[3][i] = upr(w,3);
#endif
    }
